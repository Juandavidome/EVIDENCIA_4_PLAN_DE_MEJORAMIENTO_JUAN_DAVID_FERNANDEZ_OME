...
<head>
    ...
    <link rel="stylesheet" href="./assets/CSS/Style_perdedor.css">
    <link rel="shortcut icon" href="./assets/IMAGENES/balon-de-futbol.png">
</head>
<body>
        <section class="inicio" id="inicio">
            <div class="content">
                <h3><span>¡HAS PERDIDO EL MUNDIAL!</span></h3>
                <br>
                <br>
                <br>
                <hr>
                <br>
                <p align="center"><a class="regla" href="juego.jsp">VOLVER A INICIO</a></p>
            </div>
        </section>
</body>
</html>