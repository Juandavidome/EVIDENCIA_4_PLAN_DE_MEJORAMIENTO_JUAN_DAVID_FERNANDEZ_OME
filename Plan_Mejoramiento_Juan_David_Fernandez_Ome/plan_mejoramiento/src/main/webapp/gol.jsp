...
<head>
    ...
    <link rel="stylesheet" href="./assets/CSS/Style_gol.css">
    <link rel="shortcut icon" href="./assets/IMAGENES/balon-de-futbol.png">
</head>
<body>
        <section class="inicio" id="inicio">
            <div class="content">
                <h3><span>¡GOOL!</span></h3>
                <p align="center"><a class="regla" href="Jugar1.jsp">SEGUIR A RONDA 2</a></p>
                <p align="center"><a class="regla" href="Jugar2.jsp">SEGUIR A RONDA 3</a></p>
            </div>
        </section>
</body>
</html>